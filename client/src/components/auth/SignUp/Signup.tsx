...
import Logins from '../General/LoginStyle';
    ...
    <Logins.Container>
      <Logins.Box>
        ...
        <Logins.IdBox>
          ...
          <Signups.Certified>
            <Signups.CertifiedButton onClick={() => findemail()}>인증번호 받기</Signups.CertifiedButton>
          </Signups.Certified>
        </Logins.IdBox>
        ...
        <Logins.PasswordBox>
          <Logins.NameBox color={!passwordCheck.hidden ? 'red' : 'black'}>
            ...
            />
            <Logins.HiddenMessage hidden={passwordCheck.hidden}>{passwordCheck.text}</Logins.HiddenMessage>
          </Logins.NameBox>
          {!passwordCheck.hidden && <Logins.HiddenMessage>비밀번호가 일치하지 않습니다.</Logins.HiddenMessage>}
        </Logins.PasswordBox>
