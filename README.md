...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='https://user-images.githubusercontent.com/87120463/224660261-add5d00a-88cc-4b75-82b0-8e4ca52113b5.png' width='70px' height='80px'/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='https://user-images.githubusercontent.com/87120463/224661925-d9dbd942-d8ec-432b-9e98-ae7e01386387.png' width='70px' height='80px'/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='https://user-images.githubusercontent.com/87120463/224661643-7ed27ea2-afdd-40da-b416-f21c9099ec06.png' width='70px' height='80px'/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='https://user-images.githubusercontent.com/87120463/224661642-503d43b0-4a4a-4108-8da1-de1573721317.png' width='70px' height='80px'/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='https://user-images.githubusercontent.com/87120463/224655991-4f640a09-6f91-4f0f-8bf6-1b7712494fd5.png' width='70px' height='80px'/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='https://user-images.githubusercontent.com/87120463/224655989-e348152e-079f-4e5f-8928-1de82a634283.png' width='70px' height='80px'/>
...
- OAuth2.0 (구글, 카카오)을 이용한 소셜 로그인 기능을 구현했습니다.
- 사용자가 로그인 후, 해당 OAuth의 API를 이용하여 프로필 정보를 받아와 데이터베이스에 저장하고,<br> 액세스 토큰과 리프레시 토큰을 발급해 로그인 인증을 완료합니다.
  
### 게시물기능

- 상품을 등록/조회/수정/삭제할 수 있는 기능을 구현했습니다.
- 로그인 인증을 완료한 사용자만 상품 등록이 가능하며, 등록된 상품은 메인페이지와 마이페이지에서 조회할 수 있습니다.
- 마이페이지에서는 등록한 상품을 수정하거나 삭제할 수 있으며, 삭제 시 경고창으로 UX를 개선했습니다.

### 채팅기능

- 서버와 클라이언트 간의 실시간 통신을 위해 socket.io를 사용하였습니다.
- 로그인 인증을 마친 사용자가 메인 페이지에서 원하는 상품을 클릭하여 해당 상품의 상세 페이지로 이동합니다.
- 채팅하기 버튼을 통해 해당 상품을 등록한 사용자와 소통을 시작합니다.
...
개발 환경에서 실행하고자 하는경우 [develop](https://github.com/Sort-Project/Client/tree/develop) 참조
